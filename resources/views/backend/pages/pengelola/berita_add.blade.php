...
<div class="col-12 grid-margin">
  <div class="card">
    <div class="card-body">
      ...
      <form class="form-sample" method="POST" action="/berita" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-3 mt-4">
            ...
            <input type="text" class="form-control " id="exampleInputEmail1" name="name" placeholder="berita">
            @error('name')
                        <code>
                          {{ $message }}
                        </code>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" name="deskription" placeholder="deskripsi">
            @error('deskription')
                        <code>
                          {{ $message }}
                        </code>
